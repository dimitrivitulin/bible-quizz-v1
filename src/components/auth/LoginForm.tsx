...
export default function LoginForm() {
  ...
  return (
    <div className="w-full max-w-sm">
      <h1 className="text-2xl font-bold text-amber-100 mb-1 text-center">Connexion</h1>
      <p className="text-stone-400 text-sm text-center mb-6">Retrouve ta progression</p>
      ...
      <p className="text-center text-sm text-stone-500 mt-5">
        ...
        <Link href="/inscription" className="text-amber-400 hover:underline">S&apos;inscrire</Link>
      </p>
    </div>
  )
}
